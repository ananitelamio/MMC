...
const PrimaryBackgroundContainer = tw(Container)`-mx-8 px-8 bg-secondaryBlue-600 text-gray-100`;
...
const QuoteIcon = tw(QuoteIconBase)`absolute opacity-75 top-0 left-0 transform -translate-y-2 -translate-x-1/2 sm:-translate-x-full w-10 fill-current text-primaryOrange-500`
